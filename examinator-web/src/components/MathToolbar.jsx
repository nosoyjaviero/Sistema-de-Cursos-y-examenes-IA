...
const CATEGORIAS = {
  ...
  formato: {
    ...
    plantillas: [
      ...
      { nombre: 'Paréntesis auto', latex: '\\left(#?\\right)', preview: '\\left(\\frac{a}{b}\\right)' },
      { nombre: 'Corchetes auto', latex: '\\left[#?\\right]', preview: '\\left[\\frac{a}{b}\\right]' },
      { nombre: 'Llaves auto', latex: '\\left\\{#?\\right\\}', preview: '\\left\\{x\\right\\}' },
      { nombre: 'Valor absoluto', latex: '\\left|#?\\right|', preview: '\\left|x\\right|' },
      { nombre: 'Norma', latex: '\\left\\|#?\\right\\|', preview: '\\left\\|v\\right\\|' },
      { nombre: 'Techo', latex: '\\lceil#?\\rceil', preview: '\\lceil x \\rceil' },
      { nombre: 'Piso', latex: '\\lfloor#?\\rfloor', preview: '\\lfloor x \\rfloor' },
    ]
  },
  ...
  fracciones: {
    ...
    icono: '➗',
    plantillas: [
      { nombre: 'Fracción simple', latex: '\\frac{#?}{#?}', preview: '\\frac{a}{b}' },
      { nombre: 'Fracción mixta', latex: '#?\\frac{#?}{#?}', preview: '1\\frac{1}{2}' },
      { nombre: 'Fracción pequeña', latex: '\\tfrac{#?}{#?}', preview: '\\tfrac{1}{2}' },
      { nombre: 'Fracción grande', latex: '\\dfrac{#?}{#?}', preview: '\\dfrac{a}{b}' },
      { nombre: 'Fracción continua', latex: '\\cfrac{#?}{#?}', preview: '\\cfrac{1}{1+\\cfrac{1}{2}}' },
      { nombre: 'Binomio', latex: '\\binom{#?}{#?}', preview: '\\binom{n}{k}' },
      { nombre: 'Coef. binomial', latex: '\\dbinom{#?}{#?}', preview: '\\dbinom{n}{r}' },
    ]
  },
  potencias: {
    nombre: 'Potencias',
  ...
  raices: {
    ...
    plantillas: [
      ...
      { nombre: 'Raíz cúbica', latex: '\\sqrt[3]{#?}', preview: '\\sqrt[3]{x}' },
      { nombre: 'Raíz n-ésima', latex: '\\sqrt[#?]{#?}', preview: '\\sqrt[n]{x}' },
      { nombre: 'Raíz cuarta', latex: '\\sqrt[4]{#?}', preview: '\\sqrt[4]{x}' },
      { nombre: 'Raíz con exponente', latex: '#?^{1/#?}', preview: 'x^{1/n}' },
      { nombre: 'Raíz compleja', latex: '\\sqrt{#?+#?i}', preview: '\\sqrt{a+bi}' },
    ]
  },
  ...
  trigonometriaInversa: {
    ...
    plantillas: [
      ...
      { nombre: 'arccot', latex: '\\text{arccot}(#?)', preview: '\\text{arccot}(x)' },
      { nombre: 'arcsec', latex: '\\text{arcsec}(#?)', preview: '\\text{arcsec}(x)' },
      { nombre: 'arccsc', latex: '\\text{arccsc}(#?)', preview: '\\text{arccsc}(x)' },
    ]
  },
  hiperbolicas: {
    nombre: 'Hiperbólicas',
    ...
    plantillas: [
      ...
      { nombre: 'Coseno hiperbólico', latex: '\\cosh(#?)', preview: '\\cosh(x)' },
      { nombre: 'Tangente hiperbólica', latex: '\\tanh(#?)', preview: '\\tanh(x)' },
      { nombre: 'Cotangente hip.', latex: '\\coth(#?)', preview: '\\coth(x)' },
      { nombre: 'Secante hip.', latex: '\\text{sech}(#?)', preview: '\\text{sech}(x)' },
      { nombre: 'Cosecante hip.', latex: '\\text{csch}(#?)', preview: '\\text{csch}(x)' },
      // Inversas hiperbólicas
      { nombre: 'arcsinh', latex: '\\text{arcsinh}(#?)', preview: '\\text{arcsinh}(x)' },
      { nombre: 'arccosh', latex: '\\text{arccosh}(#?)', preview: '\\text{arccosh}(x)' },
      { nombre: 'arctanh', latex: '\\text{arctanh}(#?)', preview: '\\text{arctanh}(x)' },
    ]
  },
  ...
  logaritmos: {
    ...
    plantillas: [
      ...
      { nombre: 'Log base n', latex: '\\log_{#?}(#?)', preview: '\\log_{a}(x)' },
  ...
  derivadas: {
    ...
    icono: "f'",
    plantillas: [
      { nombre: 'd/dx', latex: '\\frac{d}{dx}#?', preview: '\\frac{d}{dx}f(x)' },
      { nombre: 'dy/dx', latex: '\\frac{dy}{dx}', preview: '\\frac{dy}{dx}' },
      { nombre: 'Derivada parcial', latex: '\\frac{\\partial #?}{\\partial #?}', preview: '\\frac{\\partial f}{\\partial x}' },
      { nombre: '∂f/∂x', latex: '\\frac{\\partial f}{\\partial x}', preview: '\\frac{\\partial f}{\\partial x}' },
      { nombre: 'Segunda derivada', latex: '\\frac{d^{2}#?}{dx^{2}}', preview: '\\frac{d^{2}y}{dx^{2}}' },
      { nombre: 'Derivada n-ésima', latex: '\\frac{d^{#?}#?}{dx^{#?}}', preview: '\\frac{d^{n}y}{dx^{n}}' },
      ...
      { nombre: 'Jacobiano', latex: '\\frac{\\partial(#?,#?)}{\\partial(#?,#?)}', preview: '\\frac{\\partial(u,v)}{\\partial(x,y)}' },
    ]
  },
  limites: {
    nombre: 'Límites',
    icono: 'lim',
    plantillas: [
      { nombre: 'Límite', latex: '\\lim_{#?\\to#?}#?', preview: '\\lim_{x\\to a}f(x)' },
      { nombre: 'Límite infinito', latex: '\\lim_{#?\\to\\infty}#?', preview: '\\lim_{x\\to\\infty}f(x)' },
      { nombre: 'Límite -∞', latex: '\\lim_{#?\\to-\\infty}#?', preview: '\\lim_{x\\to-\\infty}f(x)' },
      { nombre: 'Límite derecha', latex: '\\lim_{#?\\to#?^{+}}#?', preview: '\\lim_{x\\to a^{+}}f(x)' },
      { nombre: 'Límite izquierda', latex: '\\lim_{#?\\to#?^{-}}#?', preview: '\\lim_{x\\to a^{-}}f(x)' },
      { nombre: 'Límite 0⁺', latex: '\\lim_{#?\\to 0^{+}}#?', preview: '\\lim_{x\\to 0^{+}}f(x)' },
      { nombre: 'Límite 0⁻', latex: '\\lim_{#?\\to 0^{-}}#?', preview: '\\lim_{x\\to 0^{-}}f(x)' },
      { nombre: 'lim sup', latex: '\\limsup_{#?\\to#?}#?', preview: '\\limsup_{n\\to\\infty}a_n' },
      { nombre: 'lim inf', latex: '\\liminf_{#?\\to#?}#?', preview: '\\liminf_{n\\to\\infty}a_n' },
    ]
  },
  ...
  integrales: {
    ...
    plantillas: [
      ...
      { nombre: 'Integral evaluada', latex: '\\left[#?\\right]_{#?}^{#?}', preview: '\\left[F(x)\\right]_{a}^{b}' },
      { nombre: 'Integral doble', latex: '\\iint_{#?}#?\\,dA', preview: '\\iint_{D}f\\,dA' },
      { nombre: 'Integral triple', latex: '\\iiint_{#?}#?\\,dV', preview: '\\iiint_{V}f\\,dV' },
      { nombre: 'Integral de línea', latex: '\\int_{#?}#?\\,ds', preview: '\\int_{C}F\\,ds' },
      { nombre: 'Integral cerrada', latex: '\\oint_{#?}#?\\,d#?', preview: '\\oint_{C}F\\,ds' },
      { nombre: 'Integral superficie', latex: '\\iint_{#?}#?\\,dS', preview: '\\iint_{S}F\\,dS' },
      { nombre: 'Integral impropia', latex: '\\int_{#?}^{\\infty}#?\\,d#?', preview: '\\int_{0}^{\\infty}f\\,dx' },
    ]
  },
  ...
  series: {
    ...
    icono: '∑',
    plantillas: [
      { nombre: 'Sumatoria', latex: '\\sum_{#?}^{#?}#?', preview: '\\sum_{i=1}^{n}a_i' },
      { nombre: 'Sumatoria infinita', latex: '\\sum_{#?}^{\\infty}#?', preview: '\\sum_{n=0}^{\\infty}a_n' },
      { nombre: 'Productoria', latex: '\\prod_{#?}^{#?}#?', preview: '\\prod_{i=1}^{n}a_i' },
      { nombre: 'Serie de Taylor', latex: '\\sum_{n=0}^{\\infty}\\frac{f^{(n)}(a)}{n!}(x-a)^n', preview: '\\sum_{n=0}^{\\infty}\\frac{f^{(n)}(a)}{n!}(x-a)^n' },
      { nombre: 'Serie Maclaurin', latex: '\\sum_{n=0}^{\\infty}\\frac{f^{(n)}(0)}{n!}x^n', preview: '\\sum_{n=0}^{\\infty}\\frac{f^{(n)}(0)}{n!}x^n' },
      { nombre: 'Serie geométrica', latex: '\\sum_{n=0}^{\\infty}ar^n', preview: '\\sum_{n=0}^{\\infty}ar^n' },
      { nombre: 'Serie potencias', latex: '\\sum_{n=0}^{\\infty}c_n(x-a)^n', preview: '\\sum_{n=0}^{\\infty}c_n(x-a)^n' },
      { nombre: 'Sucesión', latex: '\\{a_n\\}_{n=#?}^{#?}', preview: '\\{a_n\\}_{n=1}^{\\infty}' },
  ...
  matrices: {
    ...
    plantillas: [
      ...
      { nombre: 'Matriz 3×3', latex: '\\begin{pmatrix}#?&#?&#?\\\\#?&#?&#?\\\\#?&#?&#?\\end{pmatrix}', preview: '\\begin{pmatrix}a&b&c\\\\d&e&f\\\\g&h&i\\end{pmatrix}' },
      { nombre: 'Matriz corchetes', latex: '\\begin{bmatrix}#?&#?\\\\#?&#?\\end{bmatrix}', preview: '\\begin{bmatrix}a&b\\\\c&d\\end{bmatrix}' },
      { nombre: 'Determinante', latex: '\\begin{vmatrix}#?&#?\\\\#?&#?\\end{vmatrix}', preview: '\\begin{vmatrix}a&b\\\\c&d\\end{vmatrix}' },
      { nombre: 'Det 3×3', latex: '\\begin{vmatrix}#?&#?&#?\\\\#?&#?&#?\\\\#?&#?&#?\\end{vmatrix}', preview: '\\begin{vmatrix}a&b&c\\\\d&e&f\\\\g&h&i\\end{vmatrix}' },
      { nombre: 'Vector columna', latex: '\\begin{bmatrix}#?\\\\#?\\\\#?\\end{bmatrix}', preview: '\\begin{bmatrix}x\\\\y\\\\z\\end{bmatrix}' },
      { nombre: 'Vector fila', latex: '\\begin{bmatrix}#?&#?&#?\\end{bmatrix}', preview: '\\begin{bmatrix}x&y&z\\end{bmatrix}' },
      ...
      { nombre: 'rank(A)', latex: '\\text{rank}(#?)', preview: '\\text{rank}(A)' },
    ]
  },
  vectores: {
    nombre: 'Vectores',
    ...
    plantillas: [
      ...
      { nombre: 'Vector negrita', latex: '\\mathbf{#?}', preview: '\\mathbf{v}' },
      ...
      { nombre: 'Producto punto', latex: '\\vec{#?}\\cdot\\vec{#?}', preview: '\\vec{a}\\cdot\\vec{b}' },
      { nombre: 'Producto cruz', latex: '\\vec{#?}\\times\\vec{#?}', preview: '\\vec{a}\\times\\vec{b}' },
      { nombre: 'Magnitud', latex: '|\\vec{#?}|', preview: '|\\vec{v}|' },
      { nombre: 'Norma', latex: '\\|\\vec{#?}\\|', preview: '\\|\\vec{v}\\|' },
      { nombre: 'Componentes', latex: '\\langle#?,#?,#?\\rangle', preview: '\\langle x,y,z\\rangle' },
    ]
  },
  ...
  calculoVectorial: {
    ...
    plantillas: [
      ...
      { nombre: 'Divergencia', latex: '\\nabla\\cdot\\vec{#?}', preview: '\\nabla\\cdot\\vec{F}' },
      { nombre: 'Rotacional', latex: '\\nabla\\times\\vec{#?}', preview: '\\nabla\\times\\vec{F}' },
      { nombre: 'Laplaciano', latex: '\\nabla^{2}#?', preview: '\\nabla^{2}f' },
      { nombre: 'Laplaciano Δ', latex: '\\Delta #?', preview: '\\Delta f' },
      { nombre: 'Derivada direccional', latex: 'D_{\\vec{u}}#?', preview: 'D_{\\vec{u}}f' },
      { nombre: 'Grad ∂/∂x', latex: '\\frac{\\partial #?}{\\partial x}\\hat{i}+\\frac{\\partial #?}{\\partial y}\\hat{j}', preview: '\\frac{\\partial f}{\\partial x}\\hat{i}+\\frac{\\partial f}{\\partial y}\\hat{j}' },
      { nombre: 'Campo vectorial', latex: '\\vec{F}(x,y,z)', preview: '\\vec{F}(x,y,z)' },
      { nombre: 'T. Stokes', latex: '\\oint_{C}\\vec{F}\\cdot d\\vec{r}=\\iint_{S}(\\nabla\\times\\vec{F})\\cdot d\\vec{S}', preview: '\\oint_C\\vec{F}\\cdot d\\vec{r}' },
      { nombre: 'T. Divergencia', latex: '\\iiint_{V}\\nabla\\cdot\\vec{F}\\,dV=\\iint_{S}\\vec{F}\\cdot d\\vec{S}', preview: '\\iiint_V\\nabla\\cdot\\vec{F}\\,dV' },
    ]
  },
  ...
  ecuacionesDif: {
    ...
    icono: 'dy',
    plantillas: [
      { nombre: 'EDO primer orden', latex: '\\frac{dy}{dx}+P(x)y=Q(x)', preview: '\\frac{dy}{dx}+P(x)y=Q(x)' },
      { nombre: 'EDO segundo orden', latex: '\\frac{d^2y}{dx^2}+#?\\frac{dy}{dx}+#?y=#?', preview: '\\frac{d^2y}{dx^2}+a\\frac{dy}{dx}+by=f' },
      { nombre: 'Separable', latex: '\\frac{dy}{dx}=f(x)g(y)', preview: '\\frac{dy}{dx}=f(x)g(y)' },
      { nombre: 'Homogénea', latex: 'y=vx', preview: 'y=vx' },
      { nombre: 'Factor integrante', latex: 'e^{\\int P(x)dx}', preview: 'e^{\\int P(x)dx}' },
      { nombre: 'Sol. general', latex: 'y=C_1e^{#?x}+C_2e^{#?x}', preview: 'y=C_1e^{r_1x}+C_2e^{r_2x}' },
      { nombre: 'Wronskiano', latex: 'W(y_1,y_2)=\\begin{vmatrix}y_1&y_2\\\\y_1\'&y_2\'\\end{vmatrix}', preview: 'W(y_1,y_2)' },
  ...
  transformadas: {
    ...
    icono: 'ℒ',
    plantillas: [
      { nombre: 'Laplace', latex: '\\mathcal{L}\\{#?\\}', preview: '\\mathcal{L}\\{f(t)\\}' },
      { nombre: 'Laplace inversa', latex: '\\mathcal{L}^{-1}\\{#?\\}', preview: '\\mathcal{L}^{-1}\\{F(s)\\}' },
      { nombre: 'Laplace integral', latex: '\\int_0^{\\infty}#?e^{-st}dt', preview: '\\int_0^{\\infty}f(t)e^{-st}dt' },
      { nombre: 'Fourier', latex: '\\mathcal{F}\\{#?\\}', preview: '\\mathcal{F}\\{f(t)\\}' },
      { nombre: 'Fourier inversa', latex: '\\mathcal{F}^{-1}\\{#?\\}', preview: '\\mathcal{F}^{-1}\\{F(\\omega)\\}' },
      { nombre: 'Serie Fourier', latex: 'a_0+\\sum_{n=1}^{\\infty}(a_n\\cos(nx)+b_n\\sin(nx))', preview: 'a_0+\\sum a_n\\cos+b_n\\sin' },
      { nombre: 'Transformada Z', latex: '\\mathcal{Z}\\{#?\\}', preview: '\\mathcal{Z}\\{f[n]\\}' },
  ...
  geometria: {
    ...
    plantillas: [
      ...
      { nombre: 'Triángulo', latex: '\\triangle #?', preview: '\\triangle ABC' },
      { nombre: 'Segmento', latex: '\\overline{#?}', preview: '\\overline{AB}' },
  ...
  probabilidad: {
    ...
    plantillas: [
      ...
      { nombre: 'Cov(X,Y)', latex: '\\text{Cov}(#?,#?)', preview: '\\text{Cov}(X,Y)' },
      { nombre: 'Normal', latex: 'N(\\mu,\\sigma^2)', preview: 'N(\\mu,\\sigma^2)' },
      { nombre: 'Binomial', latex: '\\binom{n}{k}p^k(1-p)^{n-k}', preview: '\\binom{n}{k}p^k(1-p)^{n-k}' },
    ]
  },
  ...
  conjuntos: {
    ...
    plantillas: [
      ...
      { nombre: 'Subconjunto', latex: '#?\\subseteq#?', preview: 'A\\subseteq B' },
      { nombre: 'Subconj. propio', latex: '#?\\subset#?', preview: 'A\\subset B' },
      ...
      { nombre: 'Diferencia', latex: '#?\\setminus#?', preview: 'A\\setminus B' },
  ...
  griegosMay: {
    ...
    plantillas: [
      ...
      { nombre: 'Ψ Psi', latex: '\\Psi', preview: '\\Psi' },
      { nombre: 'Ω Omega', latex: '\\Omega', preview: '\\Omega' },
      { nombre: 'ε varepsilon', latex: '\\varepsilon', preview: '\\varepsilon' },
  ...
  complejos: {
    ...
    plantillas: [
      ...
      { nombre: 'Conjugado', latex: '\\overline{#?}', preview: '\\overline{z}' },
      { nombre: '|z| módulo', latex: '|z|', preview: '|z|' },
      { nombre: 'Re(z)', latex: '\\text{Re}(#?)', preview: '\\text{Re}(z)' },
      { nombre: 'Im(z)', latex: '\\text{Im}(#?)', preview: '\\text{Im}(z)' },
      { nombre: 'Forma polar', latex: 'r(\\cos\\theta+i\\sin\\theta)', preview: 'r(\\cos\\theta+i\\sin\\theta)' },
