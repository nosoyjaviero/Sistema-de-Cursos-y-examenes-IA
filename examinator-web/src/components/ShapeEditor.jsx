...
const FIGURAS_DISPONIBLES = {
  ...
  linea: {
    ...
    svg: (props) => (
      <line
        ...
        y1={props.y}
        x2={props.x + props.length / 2}
        y2={props.y}
        stroke={props.color}
        strokeWidth={props.strokeWidth}
        transform={`rotate(${props.rotation || 0} ${props.x} ${props.y})`}
      />
    ),
      ...
      return (
        <g transform={`rotate(${props.rotation || 0} ${props.x} ${props.y})`}>
          <line
            x1={props.x - halfLen}
            y1={props.y}
            x2={props.x + halfLen - arrowSize}
            y2={props.y}
            stroke={props.color}
            strokeWidth={props.strokeWidth}
          />
          <polygon
            points={`${props.x + halfLen},${props.y} ${props.x + halfLen - arrowSize},${props.y - arrowSize / 2} ${props.x + halfLen - arrowSize},${props.y + arrowSize / 2}`}
            fill={props.color}
          />
        </g>
      );
  ...
  punto: {
    ...
    icono: "●",
    svg: (props) => (
      <circle cx={props.x} cy={props.y} r={props.size} fill={props.color} />
    ),
    defaultProps: { size: 8 },
  },
  elipse: {
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
          ...
          <div style={{ display: "flex", gap: "4px" }}>
            {["#000000", "#ffffff", "#1e40af", "#dc2626", "#059669"].map(
              (c) => (
                <button
                  key={c}
                  type="button"
      ...
      >
        ...
        {figuraActual && (
          ...
          >
            ...
            >
              <span>
                {FIGURAS_DISPONIBLES[figuraActual.tipo]?.icono}{" "}
                {FIGURAS_DISPONIBLES[figuraActual.tipo]?.nombre}
              </span>
              <button
                type="button"
            ...
            >
              ...
              {figuraActual.size !== undefined && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      actualizarFigura(figuraActual.id, {
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    actualizarFigura(figuraActual.id, { color: e.target.value })
                  }
                  style={{
                    width: "100%",
                    height: "30px",
